...
export const fetchVenueStatic = async (venueSlug: string): Promise<VenueStaticResponse> => {
...
export const fetchVenueDynamic = async (venueSlug:string):Promise<VenueDynamicResponse> => {
